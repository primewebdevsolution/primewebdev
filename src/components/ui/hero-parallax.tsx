...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="h-fit py-20 md:py-20 overflow-hidden rounded-t-[1rem] antialiased relative flex flex-col [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
...
export const Header = () => {
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full">
      ...
      <p className="max-w-2xl text-base md:text-xl mt-6 md:mt-8 dark:text-neutral-200">
